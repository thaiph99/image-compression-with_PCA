...
Để thực hiện triển khai thuật toán chúng ta sẽ thực hiện bằng 5 bước sau :

\begin{enumerate}
    \item Trừ các giá trị trung bình của các biến
          \begin{itemize}
              \item Trừ giá trị trung bình của mỗi biến khỏi tập dữ liệu để tập dữ liệu phải được tập trung vào gốc.
          \end{itemize}
    \item Tính toán ma trận phương sai
          \begin{itemize}
              \item Tính toán ma trận phương sai của dữ liệu lấy trung bình.
          \end{itemize}
    \item Tính toán ma trận phương sai
          \begin{itemize}
              \item Tính toán ma trận phương sai của dữ liệu lấy trung bình.
